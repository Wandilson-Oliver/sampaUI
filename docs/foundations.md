...
Componentes de formulario usam `border-secondary/40` como borda padrao para manter contraste consistente. `border-light` permanece reservado para divisores, paineis e outras bordas estruturais.
