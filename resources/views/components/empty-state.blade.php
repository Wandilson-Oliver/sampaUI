...
<div {{ $attributes->merge(['class' => 'flex flex-col items-center justify-center rounded-default border border-dashed border-light bg-white px-6 py-10 text-center']) }}>
