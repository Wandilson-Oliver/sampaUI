        ...
        @for ($index = 0; $index < $pinLength; $index++)
            <input
                ...
                class="{{ sampaui_classes([
                    'h-12 w-11 rounded-default border border-secondary/50 bg-white text-center text-lg font-semibold text-secondary transition placeholder:text-secondary/50 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 sm:w-12',
