...
>
    ...
    <div class="relative">
        ...
        <div
            ...
            class="absolute left-0 top-full z-[120] mt-2 w-full min-w-0 max-w-[calc(100vw-2rem)] overflow-hidden rounded-default border border-light bg-white shadow-2xl shadow-secondary/10 sm:max-w-none"
        >
