            ...
            <div class="border-b border-light p-2">
                <div class="relative">
                    ...
                    <input
                        ...
                        class="block w-full rounded-default border border-light bg-white py-2 pl-9 pr-3 text-sm text-secondary outline-none transition placeholder:text-secondary  focus:border-primary focus:ring-2 focus:ring-primary/20"
                    >
                </div>
            </div>
