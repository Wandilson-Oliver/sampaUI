...
if (! function_exists('sampaui_field_classes')) {
    ...
    function sampaui_field_classes(?string $errorMessage = null, bool $disabled = false, array $classes = []): string
    {
        return sampaui_classes(array_merge([
            'block w-full rounded-default border border-secondary/15 bg-white px-4 py-2.5 text-base text-secondary transition placeholder:text-secondary/50 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20',
